...
export class CustomersComponent {
  ...
  constructor(private modalService: NgbModal, public service: CustomersService, private formBuilder: FormBuilder, private ApiService: restApiService, private datePipe: DatePipe) {
