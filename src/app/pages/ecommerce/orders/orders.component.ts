...
export class OrdersComponent {
  ...
  constructor(private modalService: NgbModal, public service: OrdersService, private formBuilder: FormBuilder, private ApiService: restApiService, private datePipe: DatePipe) {
