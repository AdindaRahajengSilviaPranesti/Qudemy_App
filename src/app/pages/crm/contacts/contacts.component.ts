...
export class ContactsComponent {
  ...
  constructor(private modalService: NgbModal, public service: ContactsService, private formBuilder: FormBuilder, private ApiService: restApiService, private datePipe: DatePipe) {
  ...
  */
  ...
  onCheckboxChange(e: any) {
    const checkArray: FormArray = this.contactsForm.get('subItem') as FormArray;
