...
import { NgbdWalletSortableHeader, walletSortEvent } from './wallet-sortable.directive';
...
export class WalletComponent {
  ...
  constructor(public service: WalletService) {
    this.WalletList$ = service.countries$;
  ...
  ngOnInit(): void {
    ...
    */
    ...
    this._marketGraphChart('["--vz-primary"]');
...
*
*/
  onSort({ column, direction }: walletSortEvent) {
